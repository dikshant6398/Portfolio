            ...
            <div className="contact_left">
                ...
                <div className="contact_details">
                    <div className="contact_detail">
                        <img src={mail_icon} alt='mail_icon'/><p>dikshantsharma140@gmail.com</p>
                    </div>
                    <div className="contact_detail">
                        <img src={call_icon} alt='call_icon'/><p>+91 6398452375</p>
                    </div>
                    <div className="contact_detail">
                        <img src={location_icon} alt='location_icon'/><p>Ghaziabad, Uttar Pradesh, India</p>
                    </div>
                </div>
            </div>
